...
export const homeAssets = {
  media: {
    ...
    processDefineSourceV2: "/media/home/process-define-source-v2.webp",
    processQualifyStructureV2: "/media/home/process-qualify-structure-v2.webp",
    processPrepareDocumentV2: "/media/home/process-prepare-document-v2.webp",
    processMoveFollowV2: "/media/home/process-move-follow-v2.webp",
...
export const homeLanding = {
  ...
  process: {
    ...
    image: homeAssets.media.processDefineSourceV2,
    imageAlt: "Food sourcing professionals reviewing ingredient samples and packing requirements",
    ...
    steps: [
      {
        ...
        title: "Define & source",
        description:
          "We turn the buyer's intended use, specification, origin, pack, volume and destination into a clear sourcing brief, then identify suitable product and producer routes.",
        icon: homeAssets.icons.processSource,
        image: homeAssets.media.processDefineSourceV2,
        imageAlt: "Food sourcing professionals reviewing ingredient samples and a specification brief",
      },
      {
        number: "02",
        title: "Qualify & structure",
        description:
          "Product fit, producer capability, price basis, Incoterms, payment structure and timing are assessed together so the offer works commercially as well as technically.",
        icon: homeAssets.icons.processVerify,
        image: homeAssets.media.processQualifyStructureV2,
        imageAlt: "Quality and warehouse professionals checking food ingredient capacity",
      },
      {
        number: "03",
        title: "Prepare & document",
        description:
          "Samples, specifications, certifications, labels and import or export documents are aligned with the destination requirements before the route progresses.",
        icon: homeAssets.icons.processMatch,
        image: homeAssets.media.processPrepareDocumentV2,
        imageAlt: "Trade operations specialists reviewing a product sample and shipping documents",
      },
      {
        number: "04",
        title: "Move & follow through",
        description:
          "Packing, loading, logistics and shipment milestones are coordinated from origin to destination, keeping the agreed commercial and technical conditions connected through delivery.",
        icon: homeAssets.icons.processCoordinate,
        image: homeAssets.media.processMoveFollowV2,
        imageAlt: "Logistics coordinator checking food cargo during container loading",
      },
    ],
  },
  buyerPaths: [
