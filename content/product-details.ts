...
const productCategoryDetailSources: Record<string, ProductCategoryDetailSource> = {
  ...
  "frozen-foods": {
    ...
    heroText: [
      ...
      "Product and cold-chain requirements are confirmed before quotation.",
    ],
    image: "/media/products/frozen-foods/frozen-foods-hero-user-v2.webp",
    imageAlt: "Assorted frozen poultry, fish, seafood, vegetables and prepared products",
    portfolioTitle: "Frozen Food Portfolio",
    portfolioText: "Five sourcing routes, each defined by different product, performance, approval and cold-chain requirements.",
    groups: [
      { id: "potatoes-produce", title: "Potatoes & Produce", description: "Frozen potato, fruit and vegetable formats matched to preparation, performance and application." },
      { id: "poultry-seafood", title: "Poultry & Seafood", description: "Animal-protein routes aligned with product identity, establishment approval and destination eligibility." },
      { id: "pastry-bakery", title: "Pastry & Bakery", description: "Frozen bakery formats selected by preparation stage, recipe, equipment and channel." },
    ],
    products: [
      product("potatoes-produce", "french-fries", "Frozen Potato Products", "French fries, wedges, hash browns and formed potato products selected for the intended kitchen, fryer and service model.", "Producer and origin confirmed by offer", "QSR, foodservice, retail and distribution", "Cut and skin status, coating or seasoning, cook instructions, finished texture, hold time, colour, defects and pack configuration", "French fries, wedges, hash browns and formed products", "Foodservice or retail bags in export cartons", { image: "/media/products/frozen-foods/frozen-potato-products-light-v1.webp", imageAlt: "Uncooked frozen French fries, wedges, hash browns and formed potato products presented as a commercial sample" }),
      product("potatoes-produce", "frozen-fruit-vegetables", "Frozen Fruit & Vegetables", "IQF and other frozen fruit and vegetable formats selected by variety, cut, grade and end use.", "Crop, origin and processor confirmed by offer", "Retail, foodservice and manufacturing", "Species and variety, cut and size, IQF/free-flowing or block format, treatment, defects, microbiological, residue and foreign-material requirements", "IQF pieces, cuts, blends, purée or block", "Retail, foodservice or industrial bags in cartons", { image: "/media/products/frozen-foods/frozen-fruit-vegetables-light-v1.webp", imageAlt: "IQF fruit and vegetables with visible natural frost presented as separate commercial samples" }),
      product("poultry-seafood", "frozen-poultry", "Frozen Poultry", "Whole birds, cuts, boneless meat and selected processed poultry matched to channel and destination approval.", "Approved country and establishment confirmed by offer", "Retail, foodservice and processing", "Species and cut, bone and skin status, processing form, unit weight, added water, halal, health, label and destination requirements", "Whole, cuts, boneless or processed", "Fixed- or catch-weight formats in food-grade inner packaging and export cartons", { image: "/media/products/frozen-foods/frozen-poultry-light-v1.webp", imageAlt: "Uncooked frozen poultry breasts, boneless thigh pieces and calibrated strips presented separately" }),
      product("poultry-seafood", "frozen-seafood", "Frozen Seafood", "Fish and seafood products defined by species, origin, production method, size and processing form.", "Species, wild/farmed status and origin confirmed by offer", "Foodservice, retail and processing", "Commercial and scientific identity, catch area or farming country, size/count, processing form, glaze, net weight, treatment, approval and health documents", "Whole, fillet, portion, block or value-added", "IQF, block, glazed, unglazed or individually packed formats", { image: "/media/products/frozen-foods/frozen-seafood-light-v1.webp", imageAlt: "Frozen white-fish portions, glazed shrimp and squid rings presented as commercial samples" }),
      product("pastry-bakery", "frozen-pastry-bakery", "Frozen Pastry & Bakery", "Ready-to-bake, proof-and-bake, part-baked and finished bakery products selected for service and retail.", "Recipe and production method confirmed by offer", "Hospitality, foodservice and retail", "Product type, recipe, fat route, allergens, unit size, thawing, proofing and baking instructions, shelf life and case configuration", "Laminated pastry, frozen dough, part-baked or finished", "Trays, bags or inner packs in frozen cartons", { image: "/media/products/frozen-foods/frozen-pastry-bakery-light-v1.webp", imageAlt: "Unbaked frozen croissants, laminated pastry, puff-pastry squares and dough portions" }),
    ],
    context: {
      title: "Frozen Food Market Context",
      edition: "2025 estimate and 2026–2034 forecast · published June 2026",
      items: [
        { value: "US$325.09bn", label: "A broad global category", description: "The global frozen food market estimate for 2025." },
        { value: "38.78%", label: "Europe holds the largest regional share", description: "Europe's estimated share of the market in 2025." },
        { value: "5.14%", label: "Growth remains forecast", description: "Forecast compound annual growth from 2026 to 2034, not a guarantee or live price indicator." },
      ],
      sources: [{ label: "Fortune Business Insights — Frozen Food Market", href: "https://www.fortunebusinessinsights.com/frozen-food-market-104138" }],
    },
    shipment: {
      ...
      items: [
        { title: "Product, Format & Channel Matching", description: "Define the exact product, preparation stage, use, performance target, pack size, volume and destination." },
        { title: "Producer, Quality & Market Approval", description: "Align the producer or establishment, certifications, specification, sample, COA and product-specific requirements." },
        { title: "Packing, Shelf Life & Cold Chain", description: "Confirm packing, palletisation, production date, remaining shelf life, −18°C handling and temperature recording." },
        { title: "Reefer Route, Documents & Delivery", description: "Coordinate the reefer route, loading checks, booking, applicable documents and delivery milestones." },
      ],
